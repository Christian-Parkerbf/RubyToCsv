...
csv_file = File.read('C:\Users\ckimura\Downloads\RubyToCsv\cautiontags.csv')
csv_text = CSV.parse(csv_file, :headers => true)

CSV.open('output.csv', 'w', write_headers: true, headers: headers) do |csv|
  CSV.foreach('C:\Users\ckimura\Downloads\RubyToCsv\cautiontags.csv', headers:true) do |row|
    csv << [
        'Product',
